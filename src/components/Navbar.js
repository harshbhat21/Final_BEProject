  ...
  return (
    <nav style={{padding:"0 5%"}} className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap py-2 shadow">
      ...
      >
        ...
        &nbsp; DBanking Wallet and Lending Platform
      </a>

      <div style={{display:"flex", alignItems:"center"}}>
        <div ><Link to="/" className={classes.pageLinks} >Home</Link></div>
        <div ><Link to="/wallet" className={classes.pageLinks} >Wallet</Link></div>
        <div ><Link to="/History" className={classes.pageLinks} >History</Link></div>
